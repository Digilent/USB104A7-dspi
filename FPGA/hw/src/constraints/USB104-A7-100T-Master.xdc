...
## Buttons
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L16N_T2_A15_D31_14 Sch=btn[0]
...
## DPTI/DSPI
set_property -dict {PACKAGE_PIN L18 IOSTANDARD LVCMOS33} [get_ports { prog_spien[0] }]; #IO_L4P_T0_D04_14     Sch=prog_spien
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports { dspi_sck_io }];  #IO_L4N_T0_D05_14     Sch=prog_d[0]/sck
set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports { dspi_io0_io }];  #IO_L5P_T0_D06_14     Sch=prog_d[1]/mosi
set_property -dict {PACKAGE_PIN R13 IOSTANDARD LVCMOS33} [get_ports { dspi_io1_io }];  #IO_L5N_T0_D07_14     Sch=prog_d[2]/miso
set_property -dict {PACKAGE_PIN M13 IOSTANDARD LVCMOS33} [get_ports { dspi_spisel }];  #IO_L6N_T0_D08_14     Sch=prog_d[3]/ss
